...
// Спизжено отсюда https://github.com/Abban/TextMeshAnimator
namespace _Game.Scripts.UI
{
    public class TextMeshAnimator : MonoBehaviour
    {
        ...
        [SerializeField] private float WaveAmount = 0.0001f;
        [SerializeField] private float WaveSpeed = 0.005f;
        [SerializeField] private float WaveSeparation = 0.5f;
        private const float DefaultShakeAmount = 0.03f;
